...
class TemperatureMachine(StateMachine):
    ...
    def processTempStateButton(self):
        ...
        ##
        ## Add the single line of code necessary to change
    ...
    def manageMyDisplay(self):
        ...
        while not self.endDisplay:
            ...
            ##
            ## Add the code necessary to setup the first line
            ## of the LCD display to incude the current date and time.
            ##
            lcd_line_1 = current_time.strftime("%m/%d %I:%M %p")[:16].ljust(16)
            ...
            if(altCounter < 6):
                ...
                ## degrees Fahrenheit.
                ##
                lcd_line_2 = f"{self.current_state.id} SP:{self.setPoint}F".ljust(16)[:16]
...
##
redButton = Button(25, pull_up=True, bounce_time=0.2)
##
## Add the single line of code necessary to assign
## a function to be triggered when the button is pushed to
...
##
blueButton = Button(12, pull_up=True, bounce_time=0.2)
##
## Add the single line of code necessary to assign
## a function to be triggered when the button is pushed to
## increase the setpoint by one degree Fahrenheit.
